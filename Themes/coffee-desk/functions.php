...
register_sidebars(1, array(
         'before_widget' => '<div class="div_wrap_sidebar"><div class="top_sidebar"></div><div class="sidebar_content" style="float: none">',
        'after_widget' => '</div><div class="bottom_sidebar"></div></div>',
        'before_title' => '<h2>',
        'after_title' => '</h2>',
       ));
